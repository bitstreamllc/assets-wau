...
@REM SET PowershellCmd=Start-Process powershell.exe -Verb RunAs -Argument -noprofile -executionpolicy bypass -file C:\BITSTREAM\WAU\INSTALL\Winget-AutoUpdate-Install.ps1 %arguments%
